...
<v-container>
  ...
  <v-row>
    <v-col cols="12" style="background-image:url('Img/tableau-guitar.jpeg') !important;background-position: center; height: 30vh; background-size: cover;">
...
export default {
  ...
  methods: {
    test() {
      ...
      this.chosenGamme = [...after.slice(indexOfSelect, 12), ...before.slice(0, indexOfSelect)]
  ...
  data() {
    return {
      ...
      select2: {name: 'Mineure', gamme: [0, 2, 3, 5, 7, 8, 10]},
    }
  },
  mounted() {
    this.test()
