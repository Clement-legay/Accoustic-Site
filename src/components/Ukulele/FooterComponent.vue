<template>
  <div class="bgded overlay row4" style="background-color: black">
    <footer id="footer" class="hoc clear">
      <!-- ################################################################################################ -->
      <div class="center btmspace-50">
        <h6 class="heading">Accoustic</h6>

        <p class="nospace">Une autre façon d'appréhender la musique.</p>
      </div>
      <!-- ################################################################################################ -->
      ...
      <div class="one_quarter">
        <h6 class="heading">Informations</h6>
      ...
      <div class="one_quarter">
        ...
        <ul class="nospace clear latestimg">
          <li><router-link to="/" class="imgover"><img src="/Img/Ukulele/uku1.jpg" alt=""></router-link></li>
          <li><router-link to="/" class="imgover"><img src="/Img/Ukulele/uku2.jpg" alt=""></router-link></li>
          <li><router-link to="/" class="imgover"><img src="/Img/Ukulele/uku3.jpg" alt=""></router-link></li>
          <li><router-link to="/" class="imgover"><img src="/Img/Ukulele/01.png" alt=""></router-link></li>
          <li><router-link to="/" class="imgover"><img src="/Img/Ukulele/01.png" alt=""></router-link></li>
          <li><router-link to="/" class="imgover"><img src="/Img/Ukulele/01.png" alt=""></router-link></li>
          <li><router-link to="/" class="imgover"><img src="/Img/Ukulele/01.png" alt=""></router-link></li>
          <li><router-link to="/" class="imgover"><img src="/Img/Ukulele/01.png" alt=""></router-link></li>
